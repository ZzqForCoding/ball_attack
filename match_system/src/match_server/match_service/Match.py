...
class Client(Iface):
    ...
    def remove_player(self, score, uuid, username, photo, channel_name):
        ...
        """
        self.send_remove_player(score, uuid, username, photo, channel_name)
        return self.recv_remove_player()

    def send_remove_player(self, score, uuid, username, photo, channel_name):
...
class Processor(Iface, TProcessor):
    ...
    def process_remove_player(self, seqid, iprot, oprot):
        ...
        result = remove_player_result()
        try:
            result.success = self._handler.remove_player(args.score, args.uuid, args.username, args.photo, args.channel_name)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
